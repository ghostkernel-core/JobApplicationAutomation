...
- Visual PDF layout in every document: body text and CV skill values are left aligned/ragged-right, not centered or fully justified; wrapped lines have natural word spacing and uniform line gaps; no large stretched spaces like over-justified text in narrow columns.
